...
Hello #{response[:name]}!
<br/><br/>
<h3><b>SESSION TIME / DESCRIPTION</b></h3>
Your session, "#{response[:session_name]}" has been scheduled from #{response[:start_time]} to #{response[:end_time]}. If you will not be physically present at the conference at this time, <b>please email amc@alliedmedia.org immediately</b> and we will see what we can do to reschedule your session. PLEASE NOTE: No schedule changes can be made after <b>12:00pm EST Tuesday, May 30th</b>.
<br/>
<br/>
...
<br/>
<br/>
<h3><b>AIRPORT SHUTTLE SIGN UP</b></h3>
...
<ul>
<li>Go to the <a href="https://www.eventbrite.com/e/allied-media-conference-2017-tickets-30102066090?aff=erelexpmlt">AMC Eventbrite page</a></li>

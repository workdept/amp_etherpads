...
Congratulations!
<br/><br/>
Your session proposal, "#{yes_info[:session_name]}", has been accepted for the 19th annual Allied Media Conference, June 15-18, 2017 as part of the "#{yes_info[:tpsng]}." Before your session is officially accepted for this year’s conference, you will need to take the following steps, listed below. Please be sure to read this entire email carefully.
<br/><br/>
Based on your scholarship request we can offer you #{yes_info[:comp_reg]} complimentary registrations and $#{yes_info[:reimbursement]} in reimbursements towards your AMC travel or housing. 
<br/><br/>
Once your session is finalized, we will put you in touch with the coordinators of your track or practice space who may be able to provide additional financial assistance.
To access reimbursement funds you must both <a href="https://docs.google.com/forms/d/e/1FAIpQLSdDHWN9vDeyXJZ5I4yceqyoN80NYtrR2xvFY5njVPTk8WBMRw/viewform">fill out this reimbursement request form</a> and submit all receipts to monica@alliedmedia.org.
<br/><br/>
Next steps:
<ol>
<li>
